...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference("Attachment.count") do
      post attachments_url, params: { attachment: { chat_session_id: @attachment.chat_session_id, file_url: @attachment.file_url } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { chat_session_id: @attachment.chat_session_id, file_url: @attachment.file_url } }
