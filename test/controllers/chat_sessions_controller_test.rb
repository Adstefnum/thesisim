...
class ChatSessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chat_session" do
    assert_difference("ChatSession.count") do
      post chat_sessions_url, params: { chat_session: { title: @chat_session.title, user_id: @chat_session.user_id } }
    end
  ...
  test "should update chat_session" do
    patch chat_session_url(@chat_session), params: { chat_session: { title: @chat_session.title, user_id: @chat_session.user_id } }
